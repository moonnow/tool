...
public final class ConfigTools {
  ...
  // 从配置参数得到Vue实体类文件路径
  public static String getVueEntityFilePathStrFromConfig(String proPath, String proAllName, String initialLowercaseEntityName) {
    if (ToolUtil.isNotNullStr(proPath) && ToolUtil.isNotNullStr(proAllName) && ToolUtil.isNotNullStr(initialLowercaseEntityName)) {
      LinkedHashMap<Integer, String> proAllNameList = new LinkedHashMap<Integer, String>();
      int proAllNameSort = 1;
      while (-1 != proAllName.indexOf("-")) {
      ...
      proPath = proPath.substring(0, proPath.length() - 1);
      proPath = proPath + "/vue/src/view/com/pro/";
      for (int i = 1; i > 0; i++) {
        if (proAllNameList.containsKey(i)) {
          proPath = proPath + proAllNameList.get(i) + "/";
        } else {
      ...
      proPath = proPath + initialLowercaseEntityName + "/" + initialLowercaseEntityName + ".js";
      return proPath;
    }
    return "";
  }
  ...
  // 从配置参数得到Vue查询类文件路径
  public static String getVueQueryFilePathStrFromConfig(String proPath, String proAllName, String initialLowercaseEntityName) {
    if (ToolUtil.isNotNullStr(proPath) && ToolUtil.isNotNullStr(proAllName) && ToolUtil.isNotNullStr(initialLowercaseEntityName)) {
      LinkedHashMap<Integer, String> proAllNameList = new LinkedHashMap<Integer, String>();
      int proAllNameSort = 1;
      while (-1 != proAllName.indexOf("-")) {
      ...
      proPath = proPath + initialLowercaseEntityName + "/" + initialLowercaseEntityName + "Query.js";
      return proPath;
    }
    return "";
  }
  ...
  // 从配置参数得到VueVO类文件路径
  public static String getVueVoFilePathStrFromConfig(String proPath, String proAllName, String initialLowercaseEntityName) {
    if (ToolUtil.isNotNullStr(proPath) && ToolUtil.isNotNullStr(proAllName) && ToolUtil.isNotNullStr(initialLowercaseEntityName)) {
      LinkedHashMap<Integer, String> proAllNameList = new LinkedHashMap<Integer, String>();
      int proAllNameSort = 1;
      while (-1 != proAllName.indexOf("-")) {
      ...
      proPath = proPath + initialLowercaseEntityName + "/" + initialLowercaseEntityName + "VO.js";
      return proPath;
    }
    return "";
  }
  ...
  public static String getVueServiceFilePathStrFromConfig(String proPath, String proAllName, String initialLowercaseEntityName) {
    if (ToolUtil.isNotNullStr(proPath) && ToolUtil.isNotNullStr(proAllName) && ToolUtil.isNotNullStr(initialLowercaseEntityName)) {
      ...
      proPath = proPath.substring(0, proPath.length() - 1);
      proPath = proPath + "/vue/src/api/com/pro/";
      for (int i = 1; i > 0; i++) {
        if (proAllNameList.containsKey(i)) {
          proPath = proPath + proAllNameList.get(i) + "/";
        } else {
  ...
  public static String getVueStoreFilePathStrFromConfig(String proPath, String proAllName, String initialLowercaseEntityName) {
    if (ToolUtil.isNotNullStr(proPath) && ToolUtil.isNotNullStr(proAllName) && ToolUtil.isNotNullStr(initialLowercaseEntityName)) {
      ...
      proPath = proPath.substring(0, proPath.length() - 1);
      proPath = proPath + "/vue/src/store/com/pro/";
      for (int i = 1; i > 0; i++) {
        if (proAllNameList.containsKey(i)) {
          proPath = proPath + proAllNameList.get(i) + "/";
        } else {
  ...
  // 从配置参数得到Vue列表页文件路径
  public static String getVueListFilePathStrFromConfig(String proPath, String proAllName, String initialLowercaseEntityName) {
    if (ToolUtil.isNotNullStr(proPath) && ToolUtil.isNotNullStr(proAllName) && ToolUtil.isNotNullStr(initialLowercaseEntityName)) {
      LinkedHashMap<Integer, String> proAllNameList = new LinkedHashMap<Integer, String>();
      int proAllNameSort = 1;
      while (-1 != proAllName.indexOf("-")) {
      ...
      proPath = proPath + initialLowercaseEntityName + "/" + initialLowercaseEntityName + "-list/" + initialLowercaseEntityName + "-list.vue";
      return proPath;
    }
    return "";
  }
  ...
  // 从配置参数得到Vue列表页样式文件路径
  public static String getVueListCssFilePathStrFromConfig(String proPath, String proAllName, String initialLowercaseEntityName) {
    if (ToolUtil.isNotNullStr(proPath) && ToolUtil.isNotNullStr(proAllName) && ToolUtil.isNotNullStr(initialLowercaseEntityName)) {
      LinkedHashMap<Integer, String> proAllNameList = new LinkedHashMap<Integer, String>();
      int proAllNameSort = 1;
      while (-1 != proAllName.indexOf("-")) {
      ...
      proPath = proPath + initialLowercaseEntityName + "/" + initialLowercaseEntityName + "-list/" + initialLowercaseEntityName + "-list.less";
      return proPath;
    }
    return "";
  }
  ...
  // 从配置参数得到Vue编辑页文件路径
  public static String getVueEditFilePathStrFromConfig(String proPath, String proAllName, String initialLowercaseEntityName) {
    if (ToolUtil.isNotNullStr(proPath) && ToolUtil.isNotNullStr(proAllName) && ToolUtil.isNotNullStr(initialLowercaseEntityName)) {
      LinkedHashMap<Integer, String> proAllNameList = new LinkedHashMap<Integer, String>();
      int proAllNameSort = 1;
      while (-1 != proAllName.indexOf("-")) {
      ...
      proPath = proPath + initialLowercaseEntityName + "/" + initialLowercaseEntityName + "-edit/" + initialLowercaseEntityName + "-edit.vue";
      return proPath;
    }
    return "";
  }
  ...
  // 从配置参数得到Vue编辑页样式文件路径
  public static String getVueEditCssFilePathStrFromConfig(String proPath, String proAllName, String initialLowercaseEntityName) {
    if (ToolUtil.isNotNullStr(proPath) && ToolUtil.isNotNullStr(proAllName) && ToolUtil.isNotNullStr(initialLowercaseEntityName)) {
      LinkedHashMap<Integer, String> proAllNameList = new LinkedHashMap<Integer, String>();
      int proAllNameSort = 1;
      while (-1 != proAllName.indexOf("-")) {
      ...
      proPath = proPath + initialLowercaseEntityName + "/" + initialLowercaseEntityName + "-edit/" + initialLowercaseEntityName + "-edit.less";
      return proPath;
    }
    return "";
  }
  ...
  // 从配置参数得到Vue详情页文件路径
  public static String getVueDetailFilePathStrFromConfig(String proPath, String proAllName, String initialLowercaseEntityName) {
    if (ToolUtil.isNotNullStr(proPath) && ToolUtil.isNotNullStr(proAllName) && ToolUtil.isNotNullStr(initialLowercaseEntityName)) {
      LinkedHashMap<Integer, String> proAllNameList = new LinkedHashMap<Integer, String>();
      int proAllNameSort = 1;
      while (-1 != proAllName.indexOf("-")) {
      ...
      proPath = proPath + initialLowercaseEntityName + "/" + initialLowercaseEntityName + "-detail/" + initialLowercaseEntityName + "-detail.vue";
      return proPath;
    }
    return "";
  }
  ...
  // 从配置参数得到Vue详情页样式文件路径
  public static String getVueDetailCssFilePathStrFromConfig(String proPath, String proAllName, String initialLowercaseEntityName) {
    if (ToolUtil.isNotNullStr(proPath) && ToolUtil.isNotNullStr(proAllName) && ToolUtil.isNotNullStr(initialLowercaseEntityName)) {
      LinkedHashMap<Integer, String> proAllNameList = new LinkedHashMap<Integer, String>();
      int proAllNameSort = 1;
      while (-1 != proAllName.indexOf("-")) {
      ...
      proPath = proPath + initialLowercaseEntityName + "/" + initialLowercaseEntityName + "-detail/" + initialLowercaseEntityName + "-detail.less";
      return proPath;
    }
    return "";
  }
